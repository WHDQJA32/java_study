...
public class Operator01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(7/3); //실수타입으로 하려면 double 혹은 3.0
		...
		//증강 연산자
		int x = 10;
		System.out.println( x-- );  //9    //++변수 는 +를 먼저 , 변수++ +를 나중에
		...
		System.out.println(!isFinished); // !를 써서 false에서 true로 바뀐다.
		...
		//System.out.println(!b4); !는 반대로 나온다.
